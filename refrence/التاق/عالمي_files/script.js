...
function OpenBrowseImage() {	
	...
	window.open(strSearchImageURL,'','height=600,width=700,resizable=yes,status=no,scrollbars=yes,toolbar=no,menubar=no,location=no,top=190,left=250')
}	
...
function OpenPreview(albumName) 
{
	...
	{
		window.open('/PhotoGallery/Aspx/Show.aspx?PreviewMode=true&album=' + strAlbumName ,'','height=400,width=700,resizable=yes,status=yes,scrollbars=yes,toolbar=no,menubar=no,location=no,top=50,left=50')
	} 
	else if(albumName != null)
	{
		window.open('/PhotoGallery/Aspx/Show.aspx?PreviewMode=true&album=' + albumName ,'','height=400,width=700,resizable=yes,status=yes,scrollbars=yes,toolbar=no,menubar=no,location=no,top=50,left=50')
	}
	else 
	{
